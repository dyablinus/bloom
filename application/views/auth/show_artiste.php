...
<div class="col-md-8 col-md-offset-2">
    ...
    <table class="table table-striped table-hover">
        <thead>
            <tr>
                <th class="col-xs-3"><h3 class="text-center"><strong>Nom</strong></h3></th>
                <th class="col-xs-3"><h3 class="text-center"><strong>Fonction</strong></h3></th>
        ...
        <tbody>
            <?php foreach ($result->result() as $rows) { ?>
                <tr>
                    <td><h3 class="text-center"><a data-toggle="modal" data-target="#myModal<?php echo $rows->id?>"><?php echo $rows->name ?></a></h3></td>
                    <td>                            
                        <?php if (strlen(($rows->poste)) > 260) {?>
                            <h4 class="colorpara text-center"><?php $t = substr($rows->poste, 0, 60)." ...";echo $t ?> </h4>
                        <?php } else { ?>
                                <h4 class="colorpara text-center"><?php echo $rows->poste ?> </h4>
                        <?php }?>
                    </td>
                ...
                <div class="modal fade" id="myModal<?php echo $rows->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Modifier le membre</h4>
                        </div>
                        <div class="modal-body" id="contentEdit">


                                <?= form_open('equipeedit/updated_post/' . $rows->id); ?>
